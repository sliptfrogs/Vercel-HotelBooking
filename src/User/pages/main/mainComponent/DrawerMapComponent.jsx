        ...
        extra={
          <Space className="flex items-center">
            <MuiButton
              ...
              className="!bg-inherit  !text-sm !border-red-400/50 !text-red-500 !normal-case"
              sx={{
                minWidth: 0,
                gap: "6px",
                border: "1px solid",
            ...
            >
              <X size={18} className="lg:size-[15px]" />
              <span>Close</span>
            </MuiButton>
      ...
      >
        <div className="mb-5 grid grid-cols-1 lg:grid-cols-2 gap-2">
          ...
          <motion.div
            ...
            className="col-span-1 relative h-fit border rounded-lg p-1 grid grid-cols-1 lg:grid-cols-5"
          >
            {/* Image Section */}
            <div className="lg:col-span-2 relative h-full place-content-center">
              <PreviewSlider
                className="h-full"
                arrayImg={item.image}
                imageClassName="h-[30vh] sm:h-[35vh] lg:h-[56vh]"
              />
              <span
            ...
            {/* Content Section */}
            <div className="lg:col-span-3 place-content-center py-2 px-3 lg:px-5">
              ...
              {/* Price and Booking */}
              <div className="w-full flex-wrap font-bold flex items-center justify-between mt-3">
                <h5 className="text-sm w-full flex justify-center lg:text-base">
                ...
                <div className="flex w-full justify-end">
                  <MuiButton
                    ...
                    className="!bg-blue-500 !w-full hover:!opacity-85 !text-xs !border-gray-400/10 !text-white !normal-case"
                    sx={{
                      minWidth: 0,
                      gap: "6px",
                      border: "1px solid",
